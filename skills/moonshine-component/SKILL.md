...
You have access to comprehensive guidelines in `.guidelines/moonshine/components-development.md` file. This file contains:
...
Before starting, you MUST read and follow these rules from `.guidelines/moonshine/components-development.md`:
...
1. **Read the guidelines**: Open and study `.guidelines/moonshine/components-development.md`
2. **Understand the request from `$ARGUMENTS`**: What kind of component does the user need?
3. **Choose base class**:
